...
/**
 * Inbound request for wealth-related queries, typically routed from the orchestrator.
 *
 ...
 * @param parameters extracted parameters (e.g. fund name, SIP amount, policy number)
 */
public record WealthRequest(
        String sessionId,
